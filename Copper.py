...
st.markdown(f""" <style>.stApp {{
                        background:url("https://png.pngtree.com/thumb_back/fw800/background/20231011/pngtree-gleaming-copper-texture-a-shiny-metallic-background-image_13644331.png");
...
if select == "HOME":
  text_content = """
    <h2 style='text-align: center; color: black;'>Welcome to my Industrial Copper Modeling project</h2>
